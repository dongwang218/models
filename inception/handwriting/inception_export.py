...
tf.app.flags.DEFINE_string('label_file', '/tmp/inception_export/notfound',
                           """label pickle file.""")
...
def export():
  ...
  with tf.Graph().as_default():
    ...
    # Run inference.
    logits, _ = inception_model.inference(images, NUM_CLASSES + 0)
    ...
    class_descriptions = [x[0] for x in sorted(synsets.items(), key = lambda _x: _x[1])]
